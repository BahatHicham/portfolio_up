  ...
  return (
   <mesh>
    ...
    <hemisphereLight intensity={0.15}  
                    groundColor="black"/>
    {/* ce ligne et fais une point de light aux desktop */}
    <pointLight intensity={11} />
    {/* pour fais une effet dans la rotation d'objet */}
    <ambientLight intensity={0.1} />
  <directionalLight color="#915eff" position={[0, 0, 5]} />
    <spotLight position={[-20,50,10]} angle={0.12} 
    penumbra={1} intensity={1} 
    castShadow shadow-mapSize={1024}/>
    <primitive
    object={computer.scene}
    scale={isMobile ? 0.47 : 0.64}
